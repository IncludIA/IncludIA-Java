...
> *Nota: A IA processará a `descricaoOriginal` automaticamente.*
...
*Retorna a lista de candidatos ordenados por compatibilidade para a vaga especificada.*
...
3.  Conecte em: `http://localhost:8080/ws`.
